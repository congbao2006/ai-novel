    ...
    request.log.info(
      {
        ...
        dbPoolTotal: request.authPerf?.dbPoolSnapshot?.dbPoolTotal,
        dbPoolIdle: request.authPerf?.dbPoolSnapshot?.dbPoolIdle,
        dbPoolWaiting: request.authPerf?.dbPoolSnapshot?.dbPoolWaiting,
        tokenHashMs: request.authPerf?.tokenHashMs,
        poolAcquireMs: request.authPerf?.poolAcquireMs,
        dbProbeMs: request.authPerf?.dbProbeMs,
        authSqlMs: request.authPerf?.authSqlMs,
